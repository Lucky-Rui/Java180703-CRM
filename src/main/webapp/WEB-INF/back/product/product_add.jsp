		...
		<form id="form_add" onsubmit="return false" class="layui-form layui-form-pane" action="">
		  <div class="layui-form-item">
		    ...
		    <div class="layui-input-inline">
		      <input type="text" name="name" autocomplete="off" value="" placeholder="请输入" class="layui-input">
		    </div>
		  </div>
		 ...
		 <div class="layui-form-item">
		  ...
		  <div class="layui-form-item layui-form-text">
		    <label class="layui-form-label">添加详情</label>
		...
		function submitForm(){
			$.ajax({
				...
				success : function(resp) {
					if(resp.code == util.SUCCESS) {
						mylayer.confirm("添加成功，是够跳转到商品管理界面？", "${ctx}/product/getProductPage.action");
					} else {
